...
const Header = () => {
  ...
  window.addEventListener("scroll", function () {
    const header = document.querySelector(".scrollup");
    // when the scroll is higher than 200 viewport height, add the header-scroll class to a tag with the header tag
        ...
        <div className={Toggle ? "nav__menu show-menu" : "nav__menu"}>
          <ul className="nav__list grid">
            ...
            <li className="nav__item">
              ...
              >
                <i className="uil uil-scenery nav__icons"></i> Portofolio
              </a>
            </li>
